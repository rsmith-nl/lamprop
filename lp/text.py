...
def fea(l, header=False):  # {{{1
    """Return the orthoropic material data for abaqus/calculux."""
    if header is True:
        lines = [
            "Generated by lamprop {0}".format(__version__),
            "laminate: {0}".format(l.name),
    ...
    lines.append(f"{D[3][3]:.4g},293")
    lines.append("*DENSITY")
    lines.append(f"{l.ρ*1000:.0f}")
    return lines


def experimental(l, header=False):
    if header is True:
        lines = [
            "Generated by lamprop {0}".format(__version__),
            "laminate: {0}".format(l.name),
    ...
    lines.append(f"G12 = {G12/1000:.2f} GPa")
    lines.append(f"G13 = {G13/1000:.2f} GPa")
    lines.append(f"G23 = {G23/1000:.2f} GPa")
    return lines
